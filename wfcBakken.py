...
def ControlHztl(login_title):
  ...
  app[u'TDiagramForm'].ClickInput(coords=(4,550), double=True)
  app[u'TDiagramForm'].TypeKeys(wellInfo[0] + '{ESC}', with_spaces=True)
  # Add Spud, GL, and KB info underneath
  app[u'TDiagramForm'].RightClickInput(coords=(4,650))
  app[u'TDiagramForm'].TypeKeys('n')
  app[u'TDiagramForm'].ClickInput(coords=(4,650), double=True)
  app[u'TDiagramForm'].TypeKeys('G.L: ' + wellInfo[5] + ' m' + '^{ENTER}' + 'K.B.: ' + wellInfo[6] + ' m'
  + '^{ENTER}' + '^{ENTER}Spud: Month xxth, 2016 at xx hrs{ESC}', with_spaces=True)
...
def ControlVert(login_title, window_name, template_path, log_type):
  ...
  app[window_name].ClickInput(coords=(500,49), double=True)
  app[window_name].TypeKeys(wellInfo[0] + '^{ENTER}' + nameTag + '{ESC}', with_spaces=True)
  # Add Spud, GL, and KB info underneath
  ...
  + 'Spud: Month xxth, 2016 at xx hrs' + '^{ENTER}Surface Casing set at xx m MD' + '^{ENTER}Sample Point {(}xx m MD{)}: '
  + 'Month xxth, 2016 at xx hrs' + '^{ENTER}KOP {(}xx m MD{)}: Month xxth, 2016 at xx hrs'
  + '^{ENTER}Mud Up {(}xx m MD{)}: Month xxth, 2016 at xx hrs{ESC}', with_spaces=True)
  app[window_name].Wait('ready')
